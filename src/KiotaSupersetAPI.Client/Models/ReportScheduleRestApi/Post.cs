...
public partial class Post : IAdditionalDataHolder, IParsable
{
    ...
    public Models.ReportScheduleRestApi.Post_creation_method? CreationMethod { get; set; }
    ...
    public Models.ReportScheduleRestApi.Post_extra Extra { get; set; }
    ...
    public Models.ReportScheduleRestApi.Post_report_format? ReportFormat { get; set; }
    ...
    public Models.ReportScheduleRestApi.Post_timezone? Timezone { get; set; }
    /// <summary>The report schedule type</summary>
    public Models.ReportScheduleRestApi.Post_type? Type { get; set; }
    ...
    public Models.ReportScheduleRestApi.Post_validator_type? ValidatorType { get; set; }
    ...
    /// <summary>
    /// Instantiates a new <see cref="Models.ReportScheduleRestApi.Post"/> and sets the default values.
    /// </summary>
    public Post()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Models.ReportScheduleRestApi.Post"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static Models.ReportScheduleRestApi.Post CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Models.ReportScheduleRestApi.Post();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "creation_method", n => { CreationMethod = n.GetEnumValue<Models.ReportScheduleRestApi.Post_creation_method>(); } },
            ...
            { "extra", n => { Extra = n.GetObjectValue<Models.ReportScheduleRestApi.Post_extra>(Models.ReportScheduleRestApi.Post_extra.CreateFromDiscriminatorValue); } },
            ...
            { "report_format", n => { ReportFormat = n.GetEnumValue<Models.ReportScheduleRestApi.Post_report_format>(); } },
            { "selected_tabs", n => { SelectedTabs = n.GetCollectionOfPrimitiveValues<int?>()?.ToList(); } },
            { "sql", n => { Sql = n.GetStringValue(); } },
            { "timezone", n => { Timezone = n.GetEnumValue<Models.ReportScheduleRestApi.Post_timezone>(); } },
            { "type", n => { Type = n.GetEnumValue<Models.ReportScheduleRestApi.Post_type>(); } },
            ...
            { "validator_type", n => { ValidatorType = n.GetEnumValue<Models.ReportScheduleRestApi.Post_validator_type>(); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteEnumValue<Models.ReportScheduleRestApi.Post_creation_method>("creation_method", CreationMethod);
        ...
        writer.WriteObjectValue<Models.ReportScheduleRestApi.Post_extra>("extra", Extra);
        ...
        writer.WriteEnumValue<Models.ReportScheduleRestApi.Post_report_format>("report_format", ReportFormat);
        writer.WriteCollectionOfPrimitiveValues<int?>("selected_tabs", SelectedTabs);
        writer.WriteStringValue("sql", Sql);
        writer.WriteEnumValue<Models.ReportScheduleRestApi.Post_timezone>("timezone", Timezone);
        writer.WriteEnumValue<Models.ReportScheduleRestApi.Post_type>("type", Type);
        writer.WriteObjectValue<Models.ValidatorConfigJSON>("validator_config_json", ValidatorConfigJson);
        writer.WriteEnumValue<Models.ReportScheduleRestApi.Post_validator_type>("validator_type", ValidatorType);
