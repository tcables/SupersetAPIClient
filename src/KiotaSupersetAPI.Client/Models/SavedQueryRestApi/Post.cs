...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="KClient.Models.SavedQueryRestApi.Post"/> and sets the default values.
        /// </summary>
        public Post()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="KClient.Models.SavedQueryRestApi.Post"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static KClient.Models.SavedQueryRestApi.Post CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new KClient.Models.SavedQueryRestApi.Post();
        }
        /// <summary>
