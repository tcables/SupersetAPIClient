...
public partial class Put : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="Models.SavedQueryRestApi.Put"/> and sets the default values.
    /// </summary>
    public Put()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Models.SavedQueryRestApi.Put"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static Models.SavedQueryRestApi.Put CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Models.SavedQueryRestApi.Put();
    }
    /// <summary>
