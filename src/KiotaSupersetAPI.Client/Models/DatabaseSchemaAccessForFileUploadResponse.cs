...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KClient.Models.DatabaseSchemaAccessForFileUploadResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KClient.Models.DatabaseSchemaAccessForFileUploadResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KClient.Models.DatabaseSchemaAccessForFileUploadResponse();
    }
    /// <summary>
