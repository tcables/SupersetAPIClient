...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KClient.Models.ChartRestApi.Get_list.SqlaTable"/> and sets the default values.
    /// </summary>
    public SqlaTable()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="KClient.Models.ChartRestApi.Get_list.SqlaTable"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static KClient.Models.ChartRestApi.Get_list.SqlaTable CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KClient.Models.ChartRestApi.Get_list.SqlaTable();
    }
    /// <summary>
