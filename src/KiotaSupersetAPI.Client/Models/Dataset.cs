...
public partial class Dataset : IAdditionalDataHolder, IParsable
{
    ...
    public Models.Dataset_column_formats ColumnFormats { get; set; }

    /// <summary>Columns metadata.</summary>
    public List<Models.Dataset_columns> Columns { get; set; }

    /// <summary>Currency formats.</summary>
    public Models.Dataset_currency_formats CurrencyFormats { get; set; }

    /// <summary>Database associated with the dataset.</summary>
    public Models.Dataset_database Database { get; set; }
    ...
    public Models.Dataset_extra Extra { get; set; }
    ...
    public List<Models.Dataset_metrics> Metrics { get; set; }
    ...
    public Models.Dataset_params Params { get; set; }
    ...
    public Models.Dataset_template_params TemplateParams { get; set; }
    ...
    public Models.Dataset_verbose_map VerboseMap { get; set; }

    /// <summary>
    /// Instantiates a new <see cref="Models.Dataset"/> and sets the default values.
    /// </summary>
    public Dataset()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Models.Dataset"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static Models.Dataset CreateFromDiscriminatorValue(IParseNode parseNode)
    {
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "column_formats", n => { ColumnFormats = n.GetObjectValue<Models.Dataset_column_formats>(Models.Dataset_column_formats.CreateFromDiscriminatorValue); } },
            { "columns", n => { Columns = n.GetCollectionOfObjectValues<Models.Dataset_columns>(Models.Dataset_columns.CreateFromDiscriminatorValue)?.ToList(); } },
            { "currency_formats", n => { CurrencyFormats = n.GetObjectValue<Models.Dataset_currency_formats>(Models.Dataset_currency_formats.CreateFromDiscriminatorValue); } },
            { "database", n => { Database = n.GetObjectValue<Models.Dataset_database>(Models.Dataset_database.CreateFromDiscriminatorValue); } },
            ...
            { "extra", n => { Extra = n.GetObjectValue<Models.Dataset_extra>(Models.Dataset_extra.CreateFromDiscriminatorValue); } },
            ...
            { "metrics", n => { Metrics = n.GetCollectionOfObjectValues<Models.Dataset_metrics>(Models.Dataset_metrics.CreateFromDiscriminatorValue)?.ToList(); } },
            ...
            { "params", n => { Params = n.GetObjectValue<Models.Dataset_params>(Models.Dataset_params.CreateFromDiscriminatorValue); } },
            ...
            { "template_params", n => { TemplateParams = n.GetObjectValue<Models.Dataset_template_params>(Models.Dataset_template_params.CreateFromDiscriminatorValue); } },
            { "time_grain_sqla", n => { TimeGrainSqla = n.GetObjectValue<UntypedNode>(UntypedNode.CreateFromDiscriminatorValue); } },
            { "type", n => { Type = n.GetStringValue(); } },
            { "uid", n => { Uid = n.GetStringValue(); } },
            { "verbose_map", n => { VerboseMap = n.GetObjectValue<Models.Dataset_verbose_map>(Models.Dataset_verbose_map.CreateFromDiscriminatorValue); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Models.Dataset_column_formats>("column_formats", ColumnFormats);
        writer.WriteCollectionOfObjectValues<Models.Dataset_columns>("columns", Columns);
        writer.WriteObjectValue<Models.Dataset_currency_formats>("currency_formats", CurrencyFormats);
        writer.WriteObjectValue<Models.Dataset_database>("database", Database);
        ...
        writer.WriteObjectValue<Models.Dataset_extra>("extra", Extra);
        ...
        writer.WriteCollectionOfObjectValues<Models.Dataset_metrics>("metrics", Metrics);
        ...
        writer.WriteObjectValue<Models.Dataset_params>("params", Params);
        ...
        writer.WriteObjectValue<Models.Dataset_template_params>("template_params", TemplateParams);
        writer.WriteObjectValue<UntypedNode>("time_grain_sqla", TimeGrainSqla);
        writer.WriteStringValue("type", Type);
        writer.WriteStringValue("uid", Uid);
        writer.WriteObjectValue<Models.Dataset_verbose_map>("verbose_map", VerboseMap);
