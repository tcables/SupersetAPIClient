...
public partial class Tag : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="Models.Tag"/> and sets the default values.
    /// </summary>
    public Tag()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Models.Tag"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static Models.Tag CreateFromDiscriminatorValue(IParseNode parseNode)
    {
