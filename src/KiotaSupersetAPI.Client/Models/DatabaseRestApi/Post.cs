...
public partial class Post : IAdditionalDataHolder, IParsable
{
    ...
    public Models.DatabaseRestApi.Post_configuration_method? ConfigurationMethod { get; set; }
    ...
    public Models.DatabaseRestApi.Post_parameters Parameters { get; set; }
    ...
    /// <summary>
    /// Instantiates a new <see cref="Models.DatabaseRestApi.Post"/> and sets the default values.
    /// </summary>
    public Post()
    {
        AdditionalData = new Dictionary<string, object>();
        ConfigurationMethod = Models.DatabaseRestApi.Post_configuration_method.Sqlalchemy_form;
    }
    /// <summary>
    /// Creates a new instance of the appropriate class based on discriminator value
    /// </summary>
    /// <returns>A <see cref="Models.DatabaseRestApi.Post"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static Models.DatabaseRestApi.Post CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Models.DatabaseRestApi.Post();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "configuration_method", n => { ConfigurationMethod = n.GetEnumValue<Models.DatabaseRestApi.Post_configuration_method>(); } },
            ...
            { "parameters", n => { Parameters = n.GetObjectValue<Models.DatabaseRestApi.Post_parameters>(Models.DatabaseRestApi.Post_parameters.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteEnumValue<Models.DatabaseRestApi.Post_configuration_method>("configuration_method", ConfigurationMethod);
        ...
        writer.WriteObjectValue<Models.DatabaseRestApi.Post_parameters>("parameters", Parameters);
