...
#pragma warning restore CS1591
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="KClient.Models.TagRestApi.Put"/> and sets the default values.
    /// </summary>
    public Put()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="KClient.Models.TagRestApi.Put"/></returns>
    /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
    public static KClient.Models.TagRestApi.Put CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KClient.Models.TagRestApi.Put();
    }
    /// <summary>
