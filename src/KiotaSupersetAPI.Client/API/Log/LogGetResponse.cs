...
public partial class LogGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public List<Models.LogRestAPI.Get_list.Get_list> Result { get; set; }

    /// <summary>
    /// Instantiates a new <see cref="API.Log.LogGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public static Log.LogGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Log.LogGetResponse();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<Log.LogGetResponse_description_columns>(Log.LogGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<Log.LogGetResponse_label_columns>(Log.LogGetResponse_label_columns.CreateFromDiscriminatorValue); } },
            ...
            { "result", n => { Result = n.GetCollectionOfObjectValues<Models.LogRestAPI.Get_list.Get_list>(Models.LogRestAPI.Get_list.Get_list.CreateFromDiscriminatorValue)?.ToList(); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Log.LogGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<Log.LogGetResponse_label_columns>("label_columns", LabelColumns);
        ...
        writer.WriteCollectionOfObjectValues<Models.LogRestAPI.Get_list.Get_list>("result", Result);
