...
public partial class WithPkGetResponse_description_columns : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="API.Log.Item.WithPkGetResponse_description_columns"/> and sets the default values.
    /// </summary>
    ...
    /// </summary>
    /// <returns>A <see cref="API.Log.Item.WithPkGetResponse_description_columns"/></returns>
