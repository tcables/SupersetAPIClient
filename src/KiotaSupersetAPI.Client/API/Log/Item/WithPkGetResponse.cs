...
public partial class WithPkGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public Models.LogRestAPI.Get.Get Result { get; set; }
    ...
    /// <summary>
    /// Instantiates a new <see cref="API.Log.Item.WithPkGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        ...
        {
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<Log.Item.WithPkGetResponse_description_columns>(Log.Item.WithPkGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "id", n => { Id = n.GetStringValue(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<Log.Item.WithPkGetResponse_label_columns>(Log.Item.WithPkGetResponse_label_columns.CreateFromDiscriminatorValue); } },
            { "result", n => { Result = n.GetObjectValue<Models.LogRestAPI.Get.Get>(Models.LogRestAPI.Get.Get.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Log.Item.WithPkGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteStringValue("id", Id);
        writer.WriteObjectValue<Log.Item.WithPkGetResponse_label_columns>("label_columns", LabelColumns);
        writer.WriteObjectValue<Models.LogRestAPI.Get.Get>("result", Result);
