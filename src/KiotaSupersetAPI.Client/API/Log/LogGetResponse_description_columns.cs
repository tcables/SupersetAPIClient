...
public partial class LogGetResponse_description_columns : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="API.Log.LogGetResponse_description_columns"/> and sets the default values.
    /// </summary>
    public LogGetResponse_description_columns()
    {
    ...
    /// </summary>
    /// <returns>A <see cref="API.Log.LogGetResponse_description_columns"/></returns>
