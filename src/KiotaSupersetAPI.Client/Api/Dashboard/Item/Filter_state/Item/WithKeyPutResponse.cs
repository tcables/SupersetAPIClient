...
public partial class WithKeyPutResponse : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="Dashboard.Item.Filter_state.Item.WithKeyPutResponse"/> and sets the default values.
    /// </summary>
    ...
    public static Dashboard.Item.Filter_state.Item.WithKeyPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Dashboard.Item.Filter_state.Item.WithKeyPutResponse();
    }
    /// <summary>
