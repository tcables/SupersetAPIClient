...
public partial class EmbeddedPutResponse : IAdditionalDataHolder, IParsable
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="Dashboard.Item.Embedded.EmbeddedPutResponse"/> and sets the default values.
    /// </summary>
    ...
    public static Dashboard.Item.Embedded.EmbeddedPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Dashboard.Item.Embedded.EmbeddedPutResponse();
    }
    /// <summary>
