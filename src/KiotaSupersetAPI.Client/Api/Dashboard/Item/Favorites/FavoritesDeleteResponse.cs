...
public partial class FavoritesDeleteResponse : IAdditionalDataHolder, IParsable
{
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        ...
        {
            { "result", n => { Result = n.GetObjectValue<Dashboard.Item.Favorites.FavoritesDeleteResponse_result>(Dashboard.Item.Favorites.FavoritesDeleteResponse_result.CreateFromDiscriminatorValue); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Dashboard.Item.Favorites.FavoritesDeleteResponse_result>("result", Result);
