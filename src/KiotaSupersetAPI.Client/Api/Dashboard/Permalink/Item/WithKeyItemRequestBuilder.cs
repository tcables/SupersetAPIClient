...
{
    /// <summary>
    /// Instantiates a new <see cref="Dashboard.Permalink.Item.WithKeyItemRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    public async Task<Dashboard.Permalink.Item.WithKeyGetResponse> GetWithKeyGetResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
        ...
        return await RequestAdapter.SendAsync<Dashboard.Permalink.Item.WithKeyGetResponse>(requestInfo, Dashboard.Permalink.Item.WithKeyGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Get dashboard&apos;s permanent link state
    /// </summary>
    ...
    public async Task<Dashboard.Permalink.Item.WithKeyResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
        ...
        return await RequestAdapter.SendAsync<Dashboard.Permalink.Item.WithKeyResponse>(requestInfo, Dashboard.Permalink.Item.WithKeyResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Get dashboard&apos;s permanent link state
    /// </summary>
