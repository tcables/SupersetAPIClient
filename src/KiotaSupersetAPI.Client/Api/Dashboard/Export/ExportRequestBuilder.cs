...
{
    /// <summary>
    /// Instantiates a new <see cref="Dashboard.Export.ExportRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    public async Task<string> GetAsync(Action<RequestConfiguration<Dashboard.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Dashboard.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Dashboard.Export.ExportRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Dashboard.Export.ExportRequestBuilder WithUrl(string rawUrl)
    {
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class ExportRequestBuilderGetRequestConfiguration : RequestConfiguration<Dashboard.Export.ExportRequestBuilder.ExportRequestBuilderGetQueryParameters>
    {
    }
}
