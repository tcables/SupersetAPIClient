...
{
    /// <summary>
    /// Instantiates a new <see cref="Dashboard.Import.ImportRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    public async Task<Dashboard.Import.ImportPostResponse> PostAsImportPostResponseAsync(Dashboard.Import.ImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
        ...
        return await RequestAdapter.SendAsync<Dashboard.Import.ImportPostResponse>(requestInfo, Dashboard.Import.ImportPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Import dashboard(s) with associated charts/datasets/databases
    /// </summary>
    ...
    public async Task<Dashboard.Import.ImportResponse> PostAsync(Dashboard.Import.ImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
        ...
        return await RequestAdapter.SendAsync<Dashboard.Import.ImportResponse>(requestInfo, Dashboard.Import.ImportResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Import dashboard(s) with associated charts/datasets/databases
    /// </summary>
    ...
    /// <param name="body">The request body</param>
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToPostRequestInformation(Dashboard.Import.ImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Dashboard.Import.ImportRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Dashboard.Import.ImportRequestBuilder WithUrl(string rawUrl)
    {
        return new Dashboard.Import.ImportRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
