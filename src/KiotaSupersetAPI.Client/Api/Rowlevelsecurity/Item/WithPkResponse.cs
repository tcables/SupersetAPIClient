...
public partial class WithPkResponse : Rowlevelsecurity.Item.WithPkDeleteResponse, IParsable
{
    ...
    public static new Rowlevelsecurity.Item.WithPkResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Rowlevelsecurity.Item.WithPkResponse();
    }
}
