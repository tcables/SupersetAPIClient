...
public partial class RowlevelsecurityGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public RowlevelsecurityGetResponse_description_columns DescriptionColumns { get; set; }
    ...
    public RowlevelsecurityGetResponse_label_columns LabelColumns { get; set; }
