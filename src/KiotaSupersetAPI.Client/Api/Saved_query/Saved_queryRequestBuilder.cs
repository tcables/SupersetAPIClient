...
public partial class Saved_queryRequestBuilder : BaseRequestBuilder
{
    ...
    public Saved_query._info._infoRequestBuilder _info
    {
        get => new Saved_query._info._infoRequestBuilder(PathParameters, RequestAdapter);
    }
    /// <summary>The distinct property</summary>
    public Saved_query.Distinct.DistinctRequestBuilder Distinct
    {
        get => new Saved_query.Distinct.DistinctRequestBuilder(PathParameters, RequestAdapter);
    }
    /// <summary>The export property</summary>
    public Saved_query.Export.ExportRequestBuilder Export
    {
        get => new Saved_query.Export.ExportRequestBuilder(PathParameters, RequestAdapter);
    }
    /// <summary>The import property</summary>
    public Saved_query.Import.ImportRequestBuilder Import
    {
        get => new Saved_query.Import.ImportRequestBuilder(PathParameters, RequestAdapter);
    }
    /// <summary>The related property</summary>
    public Saved_query.Related.RelatedRequestBuilder Related
    {
        get => new Saved_query.Related.RelatedRequestBuilder(PathParameters, RequestAdapter);
    }
    ...
    public Saved_query.Item.WithPkItemRequestBuilder this[int position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("pk", position);
            return new Saved_query.Item.WithPkItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>Gets an item from the KiotaSupersetAPI.Client.API.saved_query.item collection</summary>
    /// <param name="position">Unique identifier of the item</param>
    ...
    public Saved_query.Item.WithPkItemRequestBuilder this[string position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
    ...
    /// <summary>
    /// Instantiates a new <see cref="Saved_query.Saved_queryRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<Saved_query.Saved_queryRequestBuilder.Saved_queryRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
    {
    ...
    /// <returns>A <see cref="RequestInformation"/></returns>
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Saved_query.Saved_queryRequestBuilder.Saved_queryRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Saved_query.Saved_queryRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Saved_query.Saved_queryRequestBuilder WithUrl(string rawUrl)
    {
        return new Saved_query.Saved_queryRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Bulk delete saved queries
    /// </summary>
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class Saved_queryRequestBuilderDeleteRequestConfiguration : RequestConfiguration<Saved_query.Saved_queryRequestBuilder.Saved_queryRequestBuilderDeleteQueryParameters>
    {
    }
    /// <summary>
    /// Gets a list of saved queries, use Rison or JSON query parameters for filtering, sorting, pagination and for selecting specific columns and metadata.
    ...
    [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class Saved_queryRequestBuilderGetRequestConfiguration : RequestConfiguration<Saved_query.Saved_queryRequestBuilder.Saved_queryRequestBuilderGetQueryParameters>
    {
    }
    /// <summary>
    /// Configuration for the request such as headers, query parameters, and middleware options.
