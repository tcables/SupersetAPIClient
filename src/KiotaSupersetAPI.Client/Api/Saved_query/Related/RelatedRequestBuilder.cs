...
public partial class RelatedRequestBuilder : BaseRequestBuilder
{
    ...
    public Saved_query.Related.Item.WithColumn_nameItemRequestBuilder this[string position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("column_name", position);
            return new Saved_query.Related.Item.WithColumn_nameItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>
    /// Instantiates a new <see cref="Saved_query.Related.RelatedRequestBuilder"/> and sets the default values.
    /// </summary>
