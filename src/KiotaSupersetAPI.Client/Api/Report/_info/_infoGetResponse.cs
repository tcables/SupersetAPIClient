...
public partial class _infoGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public Report._info._infoGetResponse_add_columns AddColumns { get; set; }

    /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
    public IDictionary<string, object> AdditionalData { get; set; }
    /// <summary>The edit_columns property</summary>
    public Report._info._infoGetResponse_edit_columns EditColumns { get; set; }

    /// <summary>The filters property</summary>
    public Report._info._infoGetResponse_filters Filters { get; set; }
    ...
    public static Report._info._infoGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        ...
        return new Report._info._infoGetResponse();
    }
    /// <summary>
