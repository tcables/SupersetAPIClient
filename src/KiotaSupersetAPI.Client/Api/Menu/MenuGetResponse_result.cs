...
public partial class MenuGetResponse_result : IAdditionalDataHolder, IParsable
{
    ...
    public List<Menu.MenuGetResponse_result_childs> Childs { get; set; }
    ...
    /// <summary>
    /// Instantiates a new <see cref="Menu.MenuGetResponse_result"/> and sets the default values.
    /// </summary>
    ...
    /// </summary>
    /// <returns>A <see cref="Menu.MenuGetResponse_result"/></returns>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        ...
        {
            { "childs", n => { Childs = n.GetCollectionOfObjectValues<Menu.MenuGetResponse_result_childs>(Menu.MenuGetResponse_result_childs.CreateFromDiscriminatorValue)?.ToList(); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteCollectionOfObjectValues<Menu.MenuGetResponse_result_childs>("childs", Childs);
