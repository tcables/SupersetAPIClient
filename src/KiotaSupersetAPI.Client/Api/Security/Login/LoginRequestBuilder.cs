...
public partial class LoginRequestBuilder : BaseRequestBuilder
{
    ...
    /// <exception cref="Models.Login400Error">When receiving a 400 status code</exception>
    /// <exception cref="Models.Login401Error">When receiving a 401 status code</exception>
    /// <exception cref="Models.Login500Error">When receiving a 500 status code</exception>
    public async Task<Security.Login.LoginPostResponse> PostAsLoginPostResponseAsync(Security.Login.LoginPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
        ...
        {
            { "400", Models.Login400Error.CreateFromDiscriminatorValue },
            { "401", Models.Login401Error.CreateFromDiscriminatorValue },
            { "500", Models.Login500Error.CreateFromDiscriminatorValue },
        };
    ...
    {
        return new Login.LoginRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
