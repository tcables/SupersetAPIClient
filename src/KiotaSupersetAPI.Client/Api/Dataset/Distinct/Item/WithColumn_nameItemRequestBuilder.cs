...
public partial class WithColumn_nameItemRequestBuilder : BaseRequestBuilder
{
    ...
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Dataset.Distinct.Item.WithColumn_nameItemRequestBuilder WithUrl(string rawUrl)
    {
        return new Dataset.Distinct.Item.WithColumn_nameItemRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Get distinct values from field data
    /// </summary>
