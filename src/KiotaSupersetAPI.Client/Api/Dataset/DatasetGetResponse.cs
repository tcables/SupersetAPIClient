...
public partial class DatasetGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public Dataset.DatasetGetResponse_description_columns DescriptionColumns { get; set; }
    ...
    public Dataset.DatasetGetResponse_label_columns LabelColumns { get; set; }
    ...
    /// <summary>
    /// Instantiates a new <see cref="Dataset.DatasetGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<Dataset.DatasetGetResponse_description_columns>(Dataset.DatasetGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<Dataset.DatasetGetResponse_label_columns>(Dataset.DatasetGetResponse_label_columns.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Dataset.DatasetGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<Dataset.DatasetGetResponse_label_columns>("label_columns", LabelColumns);
