...
public partial class DatasetGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public List<Models.DatasetRestApi.Get_list.Get_list> Result { get; set; }
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "result", n => { Result = n.GetCollectionOfObjectValues<Models.DatasetRestApi.Get_list.Get_list>(Models.DatasetRestApi.Get_list.Get_list.CreateFromDiscriminatorValue)?.ToList(); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteCollectionOfObjectValues<Models.DatasetRestApi.Get_list.Get_list>("result", Result);
