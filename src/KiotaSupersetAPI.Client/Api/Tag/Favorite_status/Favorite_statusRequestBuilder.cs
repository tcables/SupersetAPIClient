...
public partial class Favorite_statusRequestBuilder : BaseRequestBuilder
{
    ...
    public async Task<Models.GetFavStarIdsSchema> GetAsync(Action<RequestConfiguration<Tag.Favorite_status.Favorite_statusRequestBuilder.Favorite_statusRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
