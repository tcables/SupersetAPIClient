...
public partial class _infoRequestBuilder : BaseRequestBuilder
{
    ...
    public async Task<KApi.Tag._info._infoGetResponse> Get_infoGetResponseAsync(Action<RequestConfiguration<KApi.Tag._info._infoRequestBuilder._infoRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
