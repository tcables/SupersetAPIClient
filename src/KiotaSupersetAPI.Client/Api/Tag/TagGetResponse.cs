...
public partial class TagGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public Tag.TagGetResponse_description_columns DescriptionColumns { get; set; }
    ...
    public Tag.TagGetResponse_label_columns LabelColumns { get; set; }
    ...
    public List<KClient.Models.TagRestApi.Get_list.Get_list> Result { get; set; }

    /// <summary>
    /// Instantiates a new <see cref="Tag.TagGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<Tag.TagGetResponse_description_columns>(Tag.TagGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<Tag.TagGetResponse_label_columns>(Tag.TagGetResponse_label_columns.CreateFromDiscriminatorValue); } },
            ...
            { "result", n => { Result = n.GetCollectionOfObjectValues<KClient.Models.TagRestApi.Get_list.Get_list>(KClient.Models.TagRestApi.Get_list.Get_list.CreateFromDiscriminatorValue)?.ToList(); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Tag.TagGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<Tag.TagGetResponse_label_columns>("label_columns", LabelColumns);
        ...
        writer.WriteCollectionOfObjectValues<KClient.Models.TagRestApi.Get_list.Get_list>("result", Result);
