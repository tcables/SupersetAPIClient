...
{
    /// <summary>
    /// Instantiates a new <see cref="Css_template._info._infoRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Css_template._info._infoRequestBuilder._infoRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Css_template._info._infoRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Css_template._info._infoRequestBuilder WithUrl(string rawUrl)
    {
        return new Css_template._info._infoRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Get metadata information about this API resource
    /// </summary>
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class _infoRequestBuilderGetRequestConfiguration : RequestConfiguration<Css_template._info._infoRequestBuilder._infoRequestBuilderGetQueryParameters>
    {
    }
}
