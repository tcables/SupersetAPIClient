...
public partial class Css_templateRequestBuilder : BaseRequestBuilder
{
    ...
    public Css_template._info._infoRequestBuilder _info
    {
        get => new Css_template._info._infoRequestBuilder(PathParameters, RequestAdapter);
    }
    /// <summary>The related property</summary>
    public Css_template.Related.RelatedRequestBuilder Related
    {
        get => new Css_template.Related.RelatedRequestBuilder(PathParameters, RequestAdapter);
    }
    ...
    public Css_template.Item.WithPkItemRequestBuilder this[int position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("pk", position);
            return new Css_template.Item.WithPkItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>Gets an item from the KiotaSupersetAPI.Client.API.css_template.item collection</summary>
    /// <param name="position">Unique identifier of the item</param>
    ...
    public Css_template.Item.WithPkItemRequestBuilder this[string position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
    ...
    /// <summary>
    /// Instantiates a new <see cref="Css_template.Css_templateRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    /// </summary>
    /// <returns>A <see cref="Css_template.Css_templatePostResponse"/></returns>
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<Css_template.Css_templateRequestBuilder.Css_templateRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
    {
    ...
    /// <returns>A <see cref="RequestInformation"/></returns>
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Css_template.Css_templateRequestBuilder.Css_templateRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="Css_template.Css_templateRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public Css_template.Css_templateRequestBuilder WithUrl(string rawUrl)
    {
        return new Css_template.Css_templateRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Bulk delete CSS templates
    /// </summary>
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class Css_templateRequestBuilderDeleteRequestConfiguration : RequestConfiguration<Css_template.Css_templateRequestBuilder.Css_templateRequestBuilderDeleteQueryParameters>
    {
    }
    /// <summary>
    /// Gets a list of CSS templates, use Rison or JSON query parameters for filtering, sorting, pagination and for selecting specific columns and metadata.
    ...
    [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class Css_templateRequestBuilderGetRequestConfiguration : RequestConfiguration<Css_template.Css_templateRequestBuilder.Css_templateRequestBuilderGetQueryParameters>
    {
    }
    /// <summary>
    /// Configuration for the request such as headers, query parameters, and middleware options.
