...
public partial class Css_templateGetResponse : IAdditionalDataHolder, IParsable
{
    ...
    public Css_template.Css_templateGetResponse_description_columns DescriptionColumns { get; set; }
    ...
    public Css_template.Css_templateGetResponse_label_columns LabelColumns { get; set; }
    ...
    public static Css_template.Css_templateGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new Css_template.Css_templateGetResponse();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<Css_template.Css_templateGetResponse_description_columns>(Css_template.Css_templateGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<Css_template.Css_templateGetResponse_label_columns>(Css_template.Css_templateGetResponse_label_columns.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<Css_template.Css_templateGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<Css_template.Css_templateGetResponse_label_columns>("label_columns", LabelColumns);
