...
public partial class RelatedRequestBuilder : BaseRequestBuilder
{
    ...
    public KApi.AnnotationLayer.Related.Item.WithColumn_nameItemRequestBuilder this[string position]
    {
        get
        {
            ...
            return new KApi.AnnotationLayer.Related.Item.WithColumn_nameItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>
    /// Instantiates a new <see cref="KApi.AnnotationLayer.Related.RelatedRequestBuilder"/> and sets the default values.
    /// </summary>
