...
public partial class WithColumn_nameItemRequestBuilder : BaseRequestBuilder
{
    ...
    public async Task<KClient.Models.RelatedResponseSchema> GetAsync(Action<RequestConfiguration<AnnotationLayer.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
