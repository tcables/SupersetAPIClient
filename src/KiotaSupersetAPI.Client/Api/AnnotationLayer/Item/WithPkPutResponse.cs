...
#pragma warning restore CS1591
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="KApi.AnnotationLayer.Item.WithPkPutResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.AnnotationLayer.Item.WithPkPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.AnnotationLayer.Item.WithPkPutResponse();
    }
    /// <summary>
