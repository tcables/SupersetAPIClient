...
namespace KiotaSupersetAPI.Client.API.Database.Related.Item;
...
{
    /// <summary>
    /// Instantiates a new <see cref="Database.Related.Item.WithColumn_nameItemRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    public async Task<KClient.Models.RelatedResponseSchema> GetAsync(Action<RequestConfiguration<Database.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Database.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class WithColumn_nameItemRequestBuilderGetRequestConfiguration : RequestConfiguration<Database.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>
    {
    }
}
