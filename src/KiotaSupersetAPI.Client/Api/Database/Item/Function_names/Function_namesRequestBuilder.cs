...
public partial class Function_namesRequestBuilder : BaseRequestBuilder
{
    ...
    /// <exception cref="Models.DatabaseFunctionNamesResponse401Error">When receiving a 401 status code</exception>
    /// <exception cref="Models.DatabaseFunctionNamesResponse404Error">When receiving a 404 status code</exception>
    /// <exception cref="Models.DatabaseFunctionNamesResponse500Error">When receiving a 500 status code</exception>
    public async Task<Models.DatabaseFunctionNamesResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {

        var requestInfo = ToGetRequestInformation(requestConfiguration);
        var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
        {
            { "401", Models.DatabaseFunctionNamesResponse401Error.CreateFromDiscriminatorValue },
            { "404", Models.DatabaseFunctionNamesResponse404Error.CreateFromDiscriminatorValue },
            { "500", Models.DatabaseFunctionNamesResponse500Error.CreateFromDiscriminatorValue },
        };
        return await RequestAdapter.SendAsync<Models.DatabaseFunctionNamesResponse>(requestInfo, Models.DatabaseFunctionNamesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Get function names supported by a database
    /// </summary>
