...
public partial class Table_extraRequestBuilder : BaseRequestBuilder
{
    ...
    public Table_extra.Item.WithTable_nameItemRequestBuilder this[string position]
    {
        get
        {
            ...
            return new Database.Item.Table_extra.Item.WithTable_nameItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>
    /// Instantiates a new <see cref="Database.Item.Table_extra.Table_extraRequestBuilder"/> and sets the default values.
    /// </summary>
