...
public partial class SchemasRequestBuilder : BaseRequestBuilder
{
    ...
    /// <exception cref="Models.SchemasResponseSchema400Error">When receiving a 400 status code</exception>
    /// <exception cref="Models.SchemasResponseSchema401Error">When receiving a 401 status code</exception>
    /// <exception cref="Models.SchemasResponseSchema404Error">When receiving a 404 status code</exception>
    /// <exception cref="Models.SchemasResponseSchema500Error">When receiving a 500 status code</exception>
    public async Task<Models.SchemasResponseSchema> GetAsync(Action<RequestConfiguration<Database.Item.Schemas.SchemasRequestBuilder.SchemasRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {

        var requestInfo = ToGetRequestInformation(requestConfiguration);
        var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
        {
            { "400", Models.SchemasResponseSchema400Error.CreateFromDiscriminatorValue },
            { "401", Models.SchemasResponseSchema401Error.CreateFromDiscriminatorValue },
            { "404", Models.SchemasResponseSchema404Error.CreateFromDiscriminatorValue },
            { "500", Models.SchemasResponseSchema500Error.CreateFromDiscriminatorValue },
        };
        return await RequestAdapter.SendAsync<Models.SchemasResponseSchema>(requestInfo, Models.SchemasResponseSchema.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Get all schemas from a database
    /// </summary>
