...
public partial class WithTable_nameItemRequestBuilder : BaseRequestBuilder
{
    ...
    public Database.Item.Table.Item.Item.WithSchema_nameItemRequestBuilder this[string position]
    {
        get
        {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("schema_name", position);
            return new Database.Item.Table.Item.Item.WithSchema_nameItemRequestBuilder(urlTplParams, RequestAdapter);
        }
    }
    /// <summary>
    /// Instantiates a new <see cref="Database.Item.Table.Item.WithTable_nameItemRequestBuilder"/> and sets the default values.
    /// </summary>
