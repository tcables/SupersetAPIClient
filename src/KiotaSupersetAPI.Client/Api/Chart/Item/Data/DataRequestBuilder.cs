...
{
    /// <summary>
    /// Instantiates a new <see cref="Chart.Item.Data.DataRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Chart.Item.Data.DataRequestBuilder.DataRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class DataRequestBuilderGetRequestConfiguration : RequestConfiguration<Chart.Item.Data.DataRequestBuilder.DataRequestBuilderGetQueryParameters>
    {
    }
}
