...
public partial class Cache_screenshotRequestBuilder : BaseRequestBuilder
{
    ...
    /// <exception cref="Models.ChartCacheScreenshotResponseSchema400Error">When receiving a 400 status code</exception>
    /// <exception cref="Models.ChartCacheScreenshotResponseSchema401Error">When receiving a 401 status code</exception>
    /// <exception cref="Models.ChartCacheScreenshotResponseSchema404Error">When receiving a 404 status code</exception>
    /// <exception cref="Models.ChartCacheScreenshotResponseSchema500Error">When receiving a 500 status code</exception>
    public async Task<Models.ChartCacheScreenshotResponseSchema> GetAsync(Action<RequestConfiguration<Chart.Item.Cache_screenshot.Cache_screenshotRequestBuilder.Cache_screenshotRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {

        var requestInfo = ToGetRequestInformation(requestConfiguration);
        var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
        {
            { "400", Models.ChartCacheScreenshotResponseSchema400Error.CreateFromDiscriminatorValue },
            { "401", Models.ChartCacheScreenshotResponseSchema401Error.CreateFromDiscriminatorValue },
            { "404", Models.ChartCacheScreenshotResponseSchema404Error.CreateFromDiscriminatorValue },
            { "500", Models.ChartCacheScreenshotResponseSchema500Error.CreateFromDiscriminatorValue },
        };
        return await RequestAdapter.SendAsync<Models.ChartCacheScreenshotResponseSchema>(requestInfo, Models.ChartCacheScreenshotResponseSchema.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
    }
    /// <summary>
    /// Compute and cache a screenshot
    /// </summary>
    ...
    {
        return new Item.Cache_screenshot.Cache_screenshotRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Compute and cache a screenshot
    /// </summary>
