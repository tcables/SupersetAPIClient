...
namespace KiotaSupersetAPI.Client.Api.V1.Assets.Export;

/// <summary>
/// Builds and executes requests for operations under \api\v1\assets\export
/// </summary>
...
public partial class ExportRequestBuilder : BaseRequestBuilder
{
    ...
    public ExportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/assets/export", pathParameters)
    {
    }
    /// <summary>
    /// Instantiates a new <see cref="KApi.Assets.Export.ExportRequestBuilder"/> and sets the default values.
    ...
    /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
    public ExportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/assets/export", rawUrl)
    {
    }
    /// <summary>
