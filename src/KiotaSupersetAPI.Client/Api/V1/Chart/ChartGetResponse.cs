...
#nullable enable
        public global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_description_columns? DescriptionColumns { get; set; }
#nullable restore
#else
        public global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_description_columns DescriptionColumns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_label_columns? LabelColumns { get; set; }
#nullable restore
#else
        public global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_label_columns LabelColumns { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "description_columns", n => { DescriptionColumns = n.GetObjectValue<global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_description_columns>(global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_description_columns.CreateFromDiscriminatorValue); } },
                { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "label_columns", n => { LabelColumns = n.GetObjectValue<global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_label_columns>(global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_label_columns.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_description_columns>("description_columns", DescriptionColumns);
            writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
            writer.WriteObjectValue<global::KiotaSupersetAPI.Client.Api.V1.Chart.ChartGetResponse_label_columns>("label_columns", LabelColumns);
