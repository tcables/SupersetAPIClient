...
namespace KiotaSupersetAPI.Client.Api.V1.Chart.Warm_up_cache;
...
{
    /// <summary>
    /// Instantiates a new <see cref="KApi.Chart.Warm_up_cache.Warm_up_cacheRequestBuilder"/> and sets the default values.
    /// </summary>
...
#nullable restore
    ...
    /// </summary>
    /// <returns>A <see cref="KApi.Chart.Warm_up_cache.Warm_up_cacheRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public KApi.Chart.Warm_up_cache.Warm_up_cacheRequestBuilder WithUrl(string rawUrl)
    {
        return new KApi.Chart.Warm_up_cache.Warm_up_cacheRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
