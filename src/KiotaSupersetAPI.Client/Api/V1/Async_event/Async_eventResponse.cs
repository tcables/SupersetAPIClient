...
namespace KiotaSupersetAPI.Client.Api.V1.Async_event
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static new global::KiotaSupersetAPI.Client.Api.V1.Async_event.Async_eventResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::KiotaSupersetAPI.Client.Api.V1.Async_event.Async_eventResponse();
        }
    }
}
