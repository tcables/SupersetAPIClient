...
#pragma warning restore CS1591
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="KApi.Explore.Permalink.PermalinkPostResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.Explore.Permalink.PermalinkPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Explore.Permalink.PermalinkPostResponse();
    }
    /// <summary>
