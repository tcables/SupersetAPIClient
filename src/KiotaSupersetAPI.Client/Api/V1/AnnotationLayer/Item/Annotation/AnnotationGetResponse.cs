...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KApi.AnnotationLayer.Item.Annotation.AnnotationGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.AnnotationLayer.Item.Annotation.AnnotationGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.AnnotationLayer.Item.Annotation.AnnotationGetResponse();
    }
    /// <summary>
