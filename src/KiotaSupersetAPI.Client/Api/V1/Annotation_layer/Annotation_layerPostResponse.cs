...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KApi.Annotation_layer.Annotation_layerPostResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.Annotation_layer.Annotation_layerPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Annotation_layer.Annotation_layerPostResponse();
    }
    /// <summary>
