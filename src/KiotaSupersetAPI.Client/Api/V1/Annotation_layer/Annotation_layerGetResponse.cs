...
using System.IO;
using System.Linq;
using KiotaSupersetAPI.Client.Models.AnnotationLayerRestApi.Get_list;
...
#nullable enable
    public KApi.Annotation_layer.Annotation_layerGetResponse_description_columns? DescriptionColumns { get; set; }
#nullable restore
#else
    public KApi.Annotation_layer.Annotation_layerGetResponse_description_columns DescriptionColumns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
    public KApi.Annotation_layer.Annotation_layerGetResponse_label_columns? LabelColumns { get; set; }
#nullable restore
#else
    public KApi.Annotation_layer.Annotation_layerGetResponse_label_columns LabelColumns { get; set; }
#endif
...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KApi.Annotation_layer.Annotation_layerGetResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.Annotation_layer.Annotation_layerGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Annotation_layer.Annotation_layerGetResponse();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<KApi.Annotation_layer.Annotation_layerGetResponse_description_columns>(KApi.Annotation_layer.Annotation_layerGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<KApi.Annotation_layer.Annotation_layerGetResponse_label_columns>(KApi.Annotation_layer.Annotation_layerGetResponse_label_columns.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<KApi.Annotation_layer.Annotation_layerGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<KApi.Annotation_layer.Annotation_layerGetResponse_label_columns>("label_columns", LabelColumns);
