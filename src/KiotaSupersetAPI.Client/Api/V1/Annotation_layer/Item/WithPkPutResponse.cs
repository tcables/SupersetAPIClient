...
#nullable restore
        ...
        public static KApi.Annotation_layer.Item.WithPkPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new KApi.Annotation_layer.Item.WithPkPutResponse();
        }
        /// <summary>
