...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<KApi.Annotation_layer.Item.Annotation.AnnotationResponse?> PostAsync(global::KiotaSupersetAPI.Client.Models.AnnotationRestApi.Post body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<KApi.Annotation_layer.Item.Annotation.AnnotationResponse> PostAsync(global::KiotaSupersetAPI.Client.Models.AnnotationRestApi.Post body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
