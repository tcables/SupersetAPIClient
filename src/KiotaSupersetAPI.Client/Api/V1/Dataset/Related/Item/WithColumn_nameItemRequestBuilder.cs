...
namespace KiotaSupersetAPI.Client.Api.V1.Dataset.Related.Item
{
    /// <summary>
...
#nullable enable
        public async Task<KClient.Models.RelatedResponseSchema?> GetAsync(Action<RequestConfiguration<KApi.Dataset.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<KClient.Models.RelatedResponseSchema> GetAsync(Action<RequestConfiguration<KApi.Dataset.Related.Item.WithColumn_nameItemRequestBuilder.WithColumn_nameItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
