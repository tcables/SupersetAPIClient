...
namespace KiotaSupersetAPI.Client.Api.V1.Dataset.Item.Metric
{
    ...
    public partial class MetricRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::KiotaSupersetAPI.Client.Api.V1.Dataset.Item.Metric.Item.WithMetric_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("metric_id", position);
                return new global::KiotaSupersetAPI.Client.Api.V1.Dataset.Item.Metric.Item.WithMetric_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the KiotaSupersetAPI.Client.api.v1.dataset.item.metric.item collection</summary>
        /// <param name="position">The metric id for this dataset</param>
        ...
        public global::KiotaSupersetAPI.Client.Api.V1.Dataset.Item.Metric.Item.WithMetric_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Dataset.Item.Metric.MetricRequestBuilder"/> and sets the default values.
        /// </summary>
