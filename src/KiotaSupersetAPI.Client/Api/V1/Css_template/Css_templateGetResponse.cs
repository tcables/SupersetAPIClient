...
using System.IO;
using System.Linq;
using KiotaSupersetAPI.Client.Models.CssTemplateRestApi.Get_list;
...
public partial class Css_templateGetResponse : IAdditionalDataHolder, IParsable
...
#nullable enable
    public KApi.Css_template.Css_templateGetResponse_description_columns? DescriptionColumns { get; set; }
#nullable restore
#else
    public KApi.Css_template.Css_templateGetResponse_description_columns DescriptionColumns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
    public KApi.Css_template.Css_templateGetResponse_label_columns? LabelColumns { get; set; }
#nullable restore
#else
    public KApi.Css_template.Css_templateGetResponse_label_columns LabelColumns { get; set; }
#endif
...
#nullable restore
...
#endif
    /// <summary>
    /// Instantiates a new <see cref="KApi.Css_template.Css_templateGetResponse"/> and sets the default values.
    /// </summary>
    public Css_templateGetResponse()
    {
    ...
    public static KApi.Css_template.Css_templateGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Css_template.Css_templateGetResponse();
    }
    /// <summary>
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "description_columns", n => { DescriptionColumns = n.GetObjectValue<KApi.Css_template.Css_templateGetResponse_description_columns>(KApi.Css_template.Css_templateGetResponse_description_columns.CreateFromDiscriminatorValue); } },
            { "ids", n => { Ids = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
            { "label_columns", n => { LabelColumns = n.GetObjectValue<KApi.Css_template.Css_templateGetResponse_label_columns>(KApi.Css_template.Css_templateGetResponse_label_columns.CreateFromDiscriminatorValue); } },
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<KApi.Css_template.Css_templateGetResponse_description_columns>("description_columns", DescriptionColumns);
        writer.WriteCollectionOfPrimitiveValues<string>("ids", Ids);
        writer.WriteObjectValue<KApi.Css_template.Css_templateGetResponse_label_columns>("label_columns", LabelColumns);
