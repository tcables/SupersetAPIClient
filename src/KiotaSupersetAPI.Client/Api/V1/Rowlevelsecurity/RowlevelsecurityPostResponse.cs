...
public partial class RowlevelsecurityPostResponse : IAdditionalDataHolder, IParsable
#pragma warning restore CS1591
{
    ...
    public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
    {
        return new Dictionary<string, Action<IParseNode>>
        {
            ...
            { "result", n => { Result = n.GetObjectValue<KClient.Models.RLSRestApi.Post>(KClient.Models.RLSRestApi.Post.CreateFromDiscriminatorValue); } },
        };
    }
    /// <summary>
    ...
    public virtual void Serialize(ISerializationWriter writer)
    {
        ...
        writer.WriteObjectValue<KClient.Models.RLSRestApi.Post>("result", Result);
