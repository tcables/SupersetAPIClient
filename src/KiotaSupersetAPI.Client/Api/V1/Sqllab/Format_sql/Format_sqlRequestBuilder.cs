...
namespace KiotaSupersetAPI.Client.Api.V1.Sqllab.Format_sql
{
    ...
    public partial class Format_sqlRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Format_sql400Error">When receiving a 400 status code</exception>
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Format_sql401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Format_sql403Error">When receiving a 403 status code</exception>
...
#nullable restore
        ...
        public async Task<global::KiotaSupersetAPI.Client.Api.V1.Sqllab.Format_sql.Format_sqlPostResponse> PostAsFormat_sqlPostResponseAsync(Stream body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::KiotaSupersetAPI.Client.Models.Format_sql400Error.CreateFromDiscriminatorValue },
                { "401", global::KiotaSupersetAPI.Client.Models.Format_sql401Error.CreateFromDiscriminatorValue },
