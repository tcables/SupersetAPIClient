...
namespace KiotaSupersetAPI.Client.Api.V1.Query.Distinct
{
    ...
    public partial class DistinctRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::KiotaSupersetAPI.Client.Api.V1.Query.Distinct.Item.WithColumn_nameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("column_name", position);
                return new global::KiotaSupersetAPI.Client.Api.V1.Query.Distinct.Item.WithColumn_nameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Query.Distinct.DistinctRequestBuilder"/> and sets the default values.
        /// </summary>
