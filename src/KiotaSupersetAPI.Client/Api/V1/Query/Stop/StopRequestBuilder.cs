...
namespace KiotaSupersetAPI.Client.Api.V1.Query.Stop
{
    ...
    public partial class StopRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Stop400Error">When receiving a 400 status code</exception>
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Stop401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::KiotaSupersetAPI.Client.Models.Stop404Error">When receiving a 404 status code</exception>
...
#nullable restore
        ...
        public async Task<global::KiotaSupersetAPI.Client.Api.V1.Query.Stop.StopPostResponse> PostAsStopPostResponseAsync(global::KiotaSupersetAPI.Client.Models.StopQuerySchema body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::KiotaSupersetAPI.Client.Models.Stop400Error.CreateFromDiscriminatorValue },
                { "401", global::KiotaSupersetAPI.Client.Models.Stop401Error.CreateFromDiscriminatorValue },
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::KiotaSupersetAPI.Client.Models.StopQuerySchema body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::KiotaSupersetAPI.Client.Models.StopQuerySchema body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
