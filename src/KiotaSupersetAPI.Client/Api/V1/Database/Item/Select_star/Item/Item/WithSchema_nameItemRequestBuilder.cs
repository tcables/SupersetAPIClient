...
namespace KiotaSupersetAPI.Client.Api.V1.Database.Item.Select_star.Item.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Select_star.Item.Item.WithSchema_nameItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Select_star.Item.Item.WithSchema_nameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Select_star.Item.Item.WithSchema_nameItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
