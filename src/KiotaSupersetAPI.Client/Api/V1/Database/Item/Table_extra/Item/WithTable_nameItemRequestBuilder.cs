...
namespace KiotaSupersetAPI.Client.Api.V1.Database.Item.Table_extra.Item
{
    ...
    public partial class WithTable_nameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Table_extra.Item.Item.WithSchema_nameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("schema_name", position);
                return new global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Table_extra.Item.Item.WithSchema_nameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Table_extra.Item.WithTable_nameItemRequestBuilder"/> and sets the default values.
        /// </summary>
