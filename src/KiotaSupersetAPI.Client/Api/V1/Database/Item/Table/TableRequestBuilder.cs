...
using KiotaSupersetAPI.Client.Api.V1.Database.Item.Table.Item;
...
namespace KiotaSupersetAPI.Client.Api.V1.Database.Item.Table
{
    ...
    {
        /// <summary>Gets an item from the KiotaSupersetAPI.Client.api.v1.database.item.table.item collection</summary>
        /// <param name="position">Table name</param>
        /// <returns>A <see cref="KApi.Database.Item.Table.Item.WithTable_nameItemRequestBuilder"/></returns>
        public KApi.Database.Item.Table.Item.WithTable_nameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("table_name", position);
                return new KApi.Database.Item.Table.Item.WithTable_nameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="KApi.Database.Item.Table.TableRequestBuilder"/> and sets the default values.
        /// </summary>
