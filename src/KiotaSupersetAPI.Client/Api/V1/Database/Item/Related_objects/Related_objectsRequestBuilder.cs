...
namespace KiotaSupersetAPI.Client.Api.V1.Database.Item.Related_objects
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Related_objects.Related_objectsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Related_objects.Related_objectsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Related_objects.Related_objectsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::KiotaSupersetAPI.Client.Api.V1.Database.Item.Related_objects.Related_objectsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
