...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<KApi.Database.Test_connection.Test_connectionResponse?> PostAsync(global::KiotaSupersetAPI.Client.Models.DatabaseTestConnectionSchema body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<KApi.Database.Test_connection.Test_connectionResponse> PostAsync(global::KiotaSupersetAPI.Client.Models.DatabaseTestConnectionSchema body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
