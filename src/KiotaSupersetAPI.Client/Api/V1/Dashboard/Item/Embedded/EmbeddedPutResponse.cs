...
public partial class EmbeddedPutResponse : IAdditionalDataHolder, IParsable
#pragma warning restore CS1591
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="KApi.Dashboard.Item.Embedded.EmbeddedPutResponse"/> and sets the default values.
    /// </summary>
    public EmbeddedPutResponse()
    {
    ...
    public static KApi.Dashboard.Item.Embedded.EmbeddedPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Dashboard.Item.Embedded.EmbeddedPutResponse();
    }
    /// <summary>
