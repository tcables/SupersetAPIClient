...
#pragma warning restore CS1591
{
    ...
    /// <summary>
    /// Instantiates a new <see cref="KApi.Dashboard.Item.Filtersets.Item.WithPkPutResponse"/> and sets the default values.
    /// </summary>
    ...
    public static KApi.Dashboard.Item.Filtersets.Item.WithPkPutResponse CreateFromDiscriminatorValue(IParseNode parseNode)
    {
        _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
        return new KApi.Dashboard.Item.Filtersets.Item.WithPkPutResponse();
    }
    /// <summary>
