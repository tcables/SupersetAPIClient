...
using KiotaSupersetAPI.Client.Api.V1.Saved_query.Related.Item;
...
{
    /// <summary>Gets an item from the KiotaSupersetAPI.Client.api.v1.saved_query.related.item collection</summary>
