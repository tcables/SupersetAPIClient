...
namespace KiotaSupersetAPI.Client.Api.V1.Tag.Favorite_status;
...
{
    /// <summary>
    /// Instantiates a new <see cref="KApi.Tag.Favorite_status.Favorite_statusRequestBuilder"/> and sets the default values.
    /// </summary>
    ...
    public async Task<KClient.Models.GetFavStarIdsSchema> GetAsync(Action<RequestConfiguration<KApi.Tag.Favorite_status.Favorite_statusRequestBuilder.Favorite_statusRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
    public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<KApi.Tag.Favorite_status.Favorite_statusRequestBuilder.Favorite_statusRequestBuilderGetQueryParameters>> requestConfiguration = default)
    {
    ...
    /// </summary>
    /// <returns>A <see cref="KApi.Tag.Favorite_status.Favorite_statusRequestBuilder"/></returns>
    /// <param name="rawUrl">The raw URL to use for the request builder.</param>
    public KApi.Tag.Favorite_status.Favorite_statusRequestBuilder WithUrl(string rawUrl)
    {
        return new KApi.Tag.Favorite_status.Favorite_statusRequestBuilder(rawUrl, RequestAdapter);
    }
    /// <summary>
    /// Get favorited tags for current user
    /// </summary>
    ...
    [GeneratedCode("Kiota", "1.16.0")]
    public partial class Favorite_statusRequestBuilderGetRequestConfiguration : RequestConfiguration<KApi.Tag.Favorite_status.Favorite_statusRequestBuilder.Favorite_statusRequestBuilderGetQueryParameters>
    {
    }
}
