...
namespace KiotaSupersetAPI.Client.Api.V1.Tag.Related
{
    ...
    public partial class RelatedRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::KiotaSupersetAPI.Client.Api.V1.Tag.Related.Item.WithColumn_nameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("column_name", position);
                return new global::KiotaSupersetAPI.Client.Api.V1.Tag.Related.Item.WithColumn_nameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::KiotaSupersetAPI.Client.Api.V1.Tag.Related.RelatedRequestBuilder"/> and sets the default values.
        /// </summary>
