...
using KiotaSupersetAPI.Client.Api.V1.Report.Related.Item;
    ...
    public partial class RelatedRequestBuilder : BaseRequestBuilder
    {
        ...
        public KApi.Report.Related.Item.WithColumn_nameItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new KApi.Report.Related.Item.WithColumn_nameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="KApi.Report.Related.RelatedRequestBuilder"/> and sets the default values.
        /// </summary>
